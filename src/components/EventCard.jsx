  ...
  return (
    ...
    <div className='event-card bg-white rounded-[5%] w-[22%] p-[2%] shadow-[0px_0px_0.5vw_rgba(0,0,0,0.6)] font-[Poppins] mb-[3%]'>
      ...
      <div className='event-name flex items-center justify-between'>
        ...
        {/* <div className='completed-icon w-[10%] h-[1.4vw] border-2'></div> */}
      </div>

      <p className='NGO-name font-semibold text-[#7A7C7D] text-[1.1vw] line-clamp-1'>NGO Name</p>
      ...
      <div className='date flex items-center gap-[2%] my-[6%]'>
        <img src={dateIcon} alt="location" className='size-[7%]' />
        <p className='text-[1vw] text-[#292929] font-medium'>DD/MM/YYY</p>
      </div>

      
      <p className='details text-[1vw] font-light line-clamp-3 mb-[10%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
